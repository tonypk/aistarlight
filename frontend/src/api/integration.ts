...
export const integrationApi = {
  // Integration Sources
  listSources: () => client.get("/integrations/sources"),

  getSource: (id: string) => client.get(`/integrations/sources/${id}`),

  createSource: (data: {
    source_system: string;
    remote_company_id: string;
    webhook_secret?: string;
  }) => client.post("/integrations/sources", data),

  deleteSource: (id: string) => client.delete(`/integrations/sources/${id}`),
  ...
  getMapping: (id: string) => client.get(`/gl-mappings/${id}`),
  ...
  deleteMapping: (id: string) => client.delete(`/gl-mappings/${id}`),
